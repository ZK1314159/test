...
import com.test.service.interfaces.AopService;
...
public class AopServiceImpl implements AopService {
    ...
    @AfterThrowing(value = "execution(* com.test.service.interfaces.CommonService.serve(..))", throwing = "e")
    ...
    @DeclareParents(value = "com.test.service.impl.CommonServiceImpl",
                    defaultImpl = IntroductionInterceptorServiceImpl.class)
